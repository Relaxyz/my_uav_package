...
void MyPositionController::InitializeParameters() {
...
void MyPositionController::CalculateRotorVelocities(Eigen::VectorXd* rotor_velocities) const {
...
void MyPositionController::SetOdometry(const EigenOdometry& odometry) {
  odometry_ = odometry;
}

void MyPositionController::SetTrajectoryPoint(
    const mav_msgs::EigenTrajectoryPoint& command_trajectory) {
  command_trajectory_ = command_trajectory;
  controller_active_ = true;
}

void MyPositionController::ComputeDesiredAcceleration(Eigen::Vector3d* acceleration) const {
  assert(acceleration);
...
void MyPositionController::ComputeDesiredAngularAcc(const Eigen::Vector3d& acceleration,
...
void MyPositionController::ComputeDesiredAngularAcc_Q(const Eigen::Vector3d& acceleration,
                                                     Eigen::Vector3d* angular_acceleration) const {
  assert(angular_acceleration);
